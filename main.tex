...
{{\vspace{2em} \Huge Review of the Inverse $\mathcal{Z}$-Transform in Discrete Option Pricing}}\\
...
\begin{equation}
\sum^{\infty}_{n = 1} q^n f(x, n) -q^0f(x, 0) = q\int^u_l \sum^{\infty}_{m = 0}q^m f(x', m) p(x-x', \triangle t)\ dx'	
\end{equation}
