...
\end{equation}
We notice the similarity to that of \autoref{unilateral_z-transform}, however we set $z^{-1} = q$ to remain consistent with that in literature. By shifting the index $m = n-1$, the expression simplifies to
\begin{equation}
